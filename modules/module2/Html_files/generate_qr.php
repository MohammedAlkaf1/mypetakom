...
<body>
    ...
    <script>
        ...
        const qrUrl = `http://10.65.91.251/mypetakom/modules/module2/Html_files/event_info.php?event_id=${eventId}`;
        ...
        setTimeout(() => {
            ...
            // Send to save_qr.php, now including qr_url
            fetch('save_qr.php', {
                    method: 'POST',
                    headers: {
                    ...
                    body: JSON.stringify({
                        event_id: eventId,
                        image_data: img.src,
                        qr_url: qrUrl // send the QR URL to be saved in the database
                    })
                })
                .then(res => res.text())
                .then(result => {
